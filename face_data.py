...
while True:
	...
	if cv2.waitKey(1) & 0xFF == ord('q'): #numlock based waitkey return 8 bit or 32 bit
		break

# Convert face list to numpy array
face_data = np.asarray(face_data)
face_data = face_data.reshape((face_data.shape[0], -1))#flastten
print face_data.shape# no of images x 30000
...
#open cv tutorial face recognition